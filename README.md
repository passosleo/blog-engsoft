...
3. [Gerenciamento de Usuários e Autenticação (Auth API)](#gerenciamento-de-usuários-e-autenticação-auth-api)
   - [Tecnologias Utilizadas](#tecnologias-utilizadas)
   - [Critérios de Aceitação](#critérios-de-aceitação)
   - [Modelo de Dados](#modelo-de-dados)
   - [Documentação da API](#documentação-da-api)
4. [Gerenciamento de Postagens (Posts API)](#gerenciamento-de-postagens-posts-api)
